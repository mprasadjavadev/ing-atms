    ...
    psm.directive('setDialogMessage', function () {
        return {
            ...
            link: function (scope, elem) {
                var sourceElem = angular.element(elem);
                if (scope.dialogProp.progressBar) {
                    sourceElem.html("<img src='../../assets/images/ajax-loader.gif' alt='Loading...'/>")
                } else {
